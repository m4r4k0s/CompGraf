...
namespace Hill_Climbing
{
    public partial class Form1 : Form, IObserver
    {
        ...
        private void InvokeLis(double par, int it)
        {
            ...
            iter.Text = (Convert.ToInt32(restarts.Text)-model.restarts).ToString();
        }
        //обертка многопоточности 
        ...
        private void start_Click(object sender, EventArgs e)
        {
            ...
            if (worc)
            {
                ...
                controller.start_search(Convert.ToInt32(iterations.Text), bord, func.Text, Convert.ToDouble(step.Text), Convert.ToInt32(restarts.Text));
            }
            else
            {
                controller.Stop();
        ...
        {
            this.worc = false;
            toolTip1.SetToolTip(restarts, "how many times do you need to start the search again");
            toolTip1.SetToolTip(iter, "number of the current attempt to find the maximum");
